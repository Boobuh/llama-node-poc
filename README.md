...
**Publication (Ukrainian, DOU):** not in this repo — draft lives locally (`docs/dou/`, gitignored) and in Google Doc; first publication on [DOU](https://dou.ua/). See [`PUBLICATION_AUDIT.md`](PUBLICATION_AUDIT.md).
