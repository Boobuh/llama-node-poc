import type { ModelRecommendationUseCase } from "../types";

const RECOMMENDATIONS: Record<ModelRecommendationUseCase, string> = {
...
const DEFAULT_RECOMMENDATION =
  "Llama-2-7B-Chat (~4GB) - Default recommendation";
