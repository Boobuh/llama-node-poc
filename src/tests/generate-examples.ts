...
async function generateExamples(): Promise<void> {
  ...
  try {
    ...
    const longText =
      "Штучний інтелект (AI) — це інтелект, який демонструють машини, на відміну від природного інтелекту, який демонструють люди та тварини. Провідні підручники з AI визначають поле як вивчення 'інтелектуальних агентів': будь-якого пристрою, який сприймає своє середовище і вживає дій, які максимізують його шанси досягти своїх цілей.";
    const r7 = await session.prompt(
      `Підсумуй цей текст одним реченням: ${longText}`,
